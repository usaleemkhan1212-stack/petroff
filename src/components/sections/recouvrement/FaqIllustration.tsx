import MarcheScene from "@/assets/icons/marche-scene.svg";
...
/**
 * The arch composition beside the FAQ — a Paris market here, where the
 * the four sibling domain pages each draw a different
 * one — and e-commerce and the service page a seventh between them.
 * Every coordinate is identical across all of them, so these components now
 * differ by a single import; that is ten near-identical copies, and the
  ...
  return (
    ...
    >
      <div className="absolute top-[8px] left-[70.5px] h-100 w-[312.5px] overflow-hidden rounded-t-full rounded-b-[25px] drop-shadow-[0px_15px_13.75px_rgba(33,29,51,0.13)]">
        <MarcheScene width={312.5} height={400} />
      </div>
