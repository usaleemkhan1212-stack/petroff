...
import { FaqIllustration } from "@/components/sections/recouvrement/FaqIllustration";
import { Container } from "@/components/ui/Container";
import { SectionHeading } from "@/components/ui/SectionHeading";
import { faqExpandedKey, faqItems } from "@/lib/recouvrement";

export function Faq() {
  const t = useTranslations("RecouvrementPage.faq");
