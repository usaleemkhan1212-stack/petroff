...
export function MidCTA() {
  const t = useTranslations("RecouvrementPage.midCta");

  return (
    <section className="bg-encre">
      <Container className="py-6">
        {/*
          **This band is 91, not the siblings' 115**: Figma pads it 24 rather
          than 36 around the same 43px row. Its row also ends exactly on the
          container's right edge, so it needs no `lg:flex-nowrap`.

          Below lg the button wraps under the copy.
        */}
