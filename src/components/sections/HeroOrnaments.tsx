...
import CourthousePaleBlue from "@/assets/icons/courthouse-pale-blue.svg";
  ...
  return (
    ...
    >
      <div className="absolute left-1/2 h-full w-[1920px] -translate-x-1/2">
        ...
        <LaurelBranchMint className="absolute top-[61px] left-[454px]" />
        <CourthousePaleBlue className="absolute top-[515px] left-[365px]" />
