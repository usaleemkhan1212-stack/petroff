import GareScene from "@/assets/icons/gare-scene.svg";
...
/**
 * The arch composition beside the FAQ — a railway station here, where the
 * Contentieux page draws Paris at the water's edge and Contrats La Défense.
 * Every coordinate is identical across all of them, so these components now
 * differ by a single import; that is five near-identical copies, and the
  ...
  return (
    ...
    >
      <div className="absolute top-[8px] left-[70.5px] h-100 w-[312.5px] overflow-hidden rounded-t-full rounded-b-[25px] drop-shadow-[0px_15px_13.75px_rgba(33,29,51,0.13)]">
        <GareScene width={312.5} height={400} />
      </div>
