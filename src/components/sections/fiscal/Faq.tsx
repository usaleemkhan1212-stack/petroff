...
import { FaqIllustration } from "@/components/sections/fiscal/FaqIllustration";
import { Container } from "@/components/ui/Container";
import { SectionHeading } from "@/components/ui/SectionHeading";
import { faqExpandedKey, faqItems } from "@/lib/fiscal";

export function Faq() {
  const t = useTranslations("FiscalPage.faq");
