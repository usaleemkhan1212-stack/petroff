...
import { FaqIllustration } from "@/components/sections/immobilier/FaqIllustration";
import { Container } from "@/components/ui/Container";
import { SectionHeading } from "@/components/ui/SectionHeading";
import { faqExpandedKey, faqItems } from "@/lib/immobilier";

export function Faq() {
  const t = useTranslations("ImmobilierPage.faq");
