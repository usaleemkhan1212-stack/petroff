...
export function MidCTA() {
  const t = useTranslations("ImmobilierPage.midCta");

  return (
    <section className="bg-encre">
      <Container className="py-9">
        {/* One line on desktop — this frame's row ends exactly on the
            container's right edge, unlike the Droit social one which overruns
            it. Below lg the button wraps under the copy. */}
