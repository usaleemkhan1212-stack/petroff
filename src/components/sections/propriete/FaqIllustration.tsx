import QuaiScene from "@/assets/icons/quai-scene.svg";
...
/**
 * The arch composition beside the FAQ — a Paris quay here, where the
 ...
 * differ by a single import; that is nine near-identical copies, and the
  ...
  return (
    ...
    >
      <div className="absolute top-[8px] left-[70.5px] h-100 w-[312.5px] overflow-hidden rounded-t-full rounded-b-[25px] drop-shadow-[0px_15px_13.75px_rgba(33,29,51,0.13)]">
        <QuaiScene width={312.5} height={400} />
      </div>
