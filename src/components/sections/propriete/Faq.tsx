...
import { FaqIllustration } from "@/components/sections/propriete/FaqIllustration";
import { Container } from "@/components/ui/Container";
import { SectionHeading } from "@/components/ui/SectionHeading";
import { faqExpandedKey, faqItems } from "@/lib/propriete";

export function Faq() {
  const t = useTranslations("ProprietePage.faq");
