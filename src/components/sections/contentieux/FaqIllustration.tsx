...
/**
 * The arch composition beside the FAQ. Offsets are the literal Figma
 * coordinates on its 383x440 box — ornament geometry, the same sanctioned
 * exception the hero ornaments use.
 *
 * The arch is a rectangular 312.5x400 illustration clipped by its container:
  ...
  return (
    ...
    >
      <div className="absolute top-[8px] left-[70.5px] h-100 w-[312.5px] overflow-hidden rounded-t-full rounded-b-[25px] drop-shadow-[0px_15px_13.75px_rgba(33,29,51,0.13)]">
        <ParisScene width={312.5} height={400} />
      </div>
