...
import { prestations } from "@/lib/contentieux";
...
/** Third copy of this pill — worth extracting to ui/ once a fourth appears. */
const tag =
  "text-small-strong text-encre/62 border-encre/8 bg-lilas rounded-full border px-3 py-1";

export function Prestations() {
  const t = useTranslations("ContentieuxPage.prestations");
