...
import { HeroOrnaments } from "@/components/sections/ma/HeroOrnaments";
import { ConsultButton } from "@/components/consultation/ConsultButton";
import { Button } from "@/components/ui/Button";
import { Container } from "@/components/ui/Container";
import { MaybeLink } from "@/components/ui/MaybeLink";
import { heroStats } from "@/lib/ma";

/**
 * Figma's `12873:884` — the Fusions-acquisitions & capital-risque hero.
 *
...
export function Hero() {
  const t = useTranslations("MaPage.hero");
    ...
    <section className="bg-lilas relative overflow-hidden">
      ...
      <Container className="relative">
        ...
        <div className="flex flex-col items-center gap-3 pt-16 pb-16 lg:min-h-180 lg:pt-16 lg:pb-0">
            ...
            <h1 className="text-display text-encre">
              {t.rich("title", {
                /*
                  ...
                  draws this bar at 396x22 on the stage, centred on it, with
                  its top at 287 — and this title runs to THREE lines, so the
                  bar sits on line three rather than line two. Against the 68px
                  display size that is 5.824em wide and 0.3235em tall, its
                  underside 0.4153em above the chunk's own box.
                ...
                */
                hl: (chunks) => (
                  <span className="relative inline-block">
                    <span
                      aria-hidden="true"
                      className="bg-pale-gold absolute bottom-[0.0771em] left-1/2 h-[0.3235em] w-[5.824em] -translate-x-1/2 rounded-[4px]"
                    />
          ...
          {/* Three stats, like the Droit fiscal and Droit social heroes. */}
