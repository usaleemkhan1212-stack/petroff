...
/**
 * The arch composition beside the FAQ — two Haussmann facades here, where the
 * Contentieux draws Paris at the water's edge, Contrats La Défense, Droit
 * fiscal a railway station and Droit social a street scene.
 * Every coordinate is identical across all of them, so these components now
 * differ by a single import; that is seven near-identical copies, and the
