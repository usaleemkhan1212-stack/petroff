...
/**
 * Figma's `13331:11276` — the site's **seventh** closing panel, and the third
 * to ask a question rather than book a slot.
 *
...
export function CTAFinal() {
  const t = useTranslations("EcommercePage.ctaFinal");
