...
import { FaqIllustration } from "@/components/sections/litiges/FaqIllustration";
import { Container } from "@/components/ui/Container";
import { SectionHeading } from "@/components/ui/SectionHeading";
import { faqExpandedKey, faqItems } from "@/lib/litiges";

export function Faq() {
  const t = useTranslations("LitigesPage.faq");
