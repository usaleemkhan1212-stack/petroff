...
import { FaqIllustration } from "@/components/sections/capital/FaqIllustration";
import { Container } from "@/components/ui/Container";
import { SectionHeading } from "@/components/ui/SectionHeading";
import { faqExpandedKey, faqItems } from "@/lib/capital";

export function Faq() {
  const t = useTranslations("CapitalPage.faq");
