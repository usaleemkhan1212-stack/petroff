...
import { FaqIllustration } from "@/components/sections/societes/FaqIllustration";
import { Container } from "@/components/ui/Container";
import { SectionHeading } from "@/components/ui/SectionHeading";
import { faqExpandedKey, faqItems } from "@/lib/societes";

export function Faq() {
  const t = useTranslations("SocietesPage.faq");
