...
export function CTAFinal() {
  ...
  const page = useTranslations("SocietesPage.ctaFinal");
        ...
        <div className="rounded-panel bg-lilas-2 relative overflow-hidden px-6 py-12 sm:px-12 lg:py-16">
          ...
          */}
          ...
          <div className="relative flex flex-col items-center gap-3 text-center">
            ...
            {/* Only the title is this page’s own - Figma writes
                a question de gouvernance where the shared block says
                a question d’associes. */}
            <h2 className="text-h2 text-encre">{page("title")}</h2>
