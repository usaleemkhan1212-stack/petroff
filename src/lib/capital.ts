...
/** Keys inside the `CapitalPage.tools.items` message namespace. */
export const tools = ["calendrier", "dataRoom", "dilution", "nda"] as const;

/** Keys inside the `CapitalPage.hero.stats` message namespace. */
...
/** Keys inside the `CapitalPage.domaines.items` message namespace. */
...
export const missions: readonly Mission[] = [
  { key: "levees", Icon: ShuffleArrowsIcon, tone: "blue" },
  { key: "dueDiligence", Icon: MagnifierIcon, tone: "gold" },
  { key: "termSheet", Icon: FileLinesIcon, tone: "mint" },
  { key: "preference", Icon: ShieldCheckIcon, tone: "pink" },
  { key: "pactes", Icon: RocketIcon, tone: "blue" },
  { key: "management", Icon: ChartLineUpIcon, tone: "gold" },
  { key: "bsaAir", Icon: GlobeIcon, tone: "mint" },
  { key: "tours", Icon: BranchSplitIcon, tone: "gold" },
  { key: "liquidite", Icon: WarningTriangleIcon, tone: "pink" },
] as const;

/** Keys inside the `CapitalPage.prestations.items` message namespace. */
...
/** Keys inside the `CapitalPage.methode.items` message namespace. */
export const methodeSteps = ["cadrage", "espace", "redaction", "signature"] as const;

/** Keys inside the `CapitalPage.forfaits.items` message namespace. */
...
/** Keys inside the `CapitalPage.espace.features` message namespace. */
...
/** Keys inside the `CapitalPage.espace.mock.rows` message namespace. */
...
/** Keys inside the `CapitalPage.faq.items` message namespace. */
export type FaqKey = "duree" | "pacte" | "leveur" | "fondsEtrangers";
